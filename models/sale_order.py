    ...
    def action_confirm(self):
        ...
        for rec in self:
            ...
            if unapproved_products:
                raise UserError("These Products are Not Approved or Mapped ({}) Please Approve or Map all Products Before Confirming the Sale Order.".format(unapproved_products))
        return super(SaleOrder, self).action_confirm()
